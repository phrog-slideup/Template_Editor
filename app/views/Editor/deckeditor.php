              ...
              <div id="slideContainer" class="visible">                
                <div id='filterhook'></div>             
                  ...
                  <div class="left-div" id="pptdataview"  <?php 
                    ...
                    <div class="tabszone tabs" <?php  if ($companyId == 3){ ?>style=" background : <?php echo $slideupliftThemeCOlor; ?>;"<?php }?>>
        ...
        <div class="editor-container">
            ...
            <div class="toolbar-container" id="textToolPanel">
                ...
                <div class="toolbar home-toolbar active">
                    ...
                    <script>
                        window.COMPANY_ID = <?= (int)$companyId ?>;
                    </script>
                    <!-- Font Group -->
                    <div class="toolbar-group">
          ...
          <div id="slidecontentdiv" style="overflow-y: <?= !empty($ppt_details) ? 'hidden' : 'auto'; ?>;" >
            ...
            <div class="theviewstarting"  style="position:relative;height:100%;">
              ...
              <ul id='allSlides' class="slide_scroll image-container <?php echo $slidesorterviewul; ?>"  >
                ...
                ?>
                <div id="blankslide" class="<?php echo $slidesorterviewblankdiv; ?> delete_slideicon image-box-blank blankslide <?php if($companyId != 4){ ?> greyoutplussign <?php } ?>" <?php  if ($companyId == 3){ ?>style=" border: 2px dashed <?php echo $slideupliftThemeCOlor; ?>;"<?php }?>  onclick="toggleSlidePanel()" >
                  <i class="fa fa-plus addopenlib" <?php  if ($companyId == 3){ ?>style=" background : <?php echo $slideupliftThemeCOlor; ?>;"<?php }?> aria-hidden="true" ></i>
                </div>
              </ul>
