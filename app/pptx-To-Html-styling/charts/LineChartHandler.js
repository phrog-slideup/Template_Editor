 ...
 * Converts PPTX line chart XML (c:lineChart) → HTML with:
 *   1. A fully visible SVG line chart rendered in the browser
 *   2. Per-point marker shapes (circle, diamond, triangle, square)
 *   3. Proper gridlines (horizontal and vertical) matching PowerPoint
 *   4. Correct spacing from axes
 *   5. data-* attributes on hidden divs for round-trip conversion
 */
